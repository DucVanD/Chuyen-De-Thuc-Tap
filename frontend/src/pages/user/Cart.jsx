...
import { FaMinus, FaPlus, FaTrash, FaTruck, FaUndoAlt, FaMoneyBillWave, FaHeadset } from "react-icons/fa";
...
const Cart = () => {
  ...
  const [cartItems, setCartItems] = useState([
    {
      id: 1,
      name: "Nước ép cỏ lúa mì",
      image: "/assets/images/wheatgrass-juice.jpg",
      price: 229000,
      quantity: 1
    },
    {
      id: 2,
      name: "Thịt vai heo tươi",
      image: "/assets/images/thit-vai.jpg",
      price: 100000,
      quantity: 2
    }
  ]);
    ...
    <>
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">Bạn có {cartItems.length} sản phẩm trong giỏ hàng</p>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="companyInvoice" className="ml-2 block text-sm text-gray-700">
        ...
        <div className="mt-8 text-center">
          <button className="bg-green-600 text-white px-12 py-4 rounded-lg hover:bg-green-700 transition-colors font-semibold text-lg">
            Thanh toán
          </button>
        </div>
